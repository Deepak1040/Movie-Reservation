							...
							return (
								<button
									...
									className={`flex flex-col items-center overflow-y-scroll row-span-${getRowSpan(
										...
										theater.number
									} mx-1 rounded p-1 text-center drop-shadow-md ${
								...
								>
									...
									<p className='text-sm leading-3'>{`${new Date(
										showtime.showtime
									)
										.getHours()
										.toString()
						...
						{auth.role === 'admin' && (
							<>
								...
								<p className='flex items-center gap-1 text-sm'>
									...
									{(
										rowToNumber(theater.seatPlan.row) * theater.seatPlan.column
